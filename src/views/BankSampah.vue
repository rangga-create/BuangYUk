...
function loadFromLocalStorage() {
  ...
  if (stored) {
    ...
    banks.value = [ // Default data jika belum ada di localStorage
      {
...
const banks = ref([
  {
    ...
    address: 'Jl. Merdeka No. 15, Bekasi Utara',
    operationalHours: 'Senin-Sabtu, 08.00-16.00',
    image: 'https://images.unsplash.com/photo-1653858712082-9877c9fbe417?q=80&w=1331&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    name: 'Bank Sampah Hijau Lestari',
    address: 'Perumahan Griya Asri Blok C2',
    operationalHours: 'Senin-Jumat, 09.00-15.00',
    image: 'https://images.unsplash.com/photo-1592209962066-db0e9b617477?q=80&w=2578&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    name: 'Bank Sampah Mandiri',
    address: 'Jl. Raya Cibubur No. 88, Jakarta',
    operationalHours: 'Setiap Hari, 07.00-17.00',
    image: 'https://images.unsplash.com/photo-1706376764637-64b34837aaa6?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    name: 'Bank Sampah Alam Hijau',
    address: 'Jl. Kenanga No. 22, Depok',
    operationalHours: 'Senin-Sabtu, 08.00-16.00',
    image: 'https://images.unsplash.com/photo-1712642178674-12d269ca9e21?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    name: 'Bank Sampah Berseri',
    address: 'Jl. Melati Indah No. 5, Tangerang',
    operationalHours: 'Senin-Jumat, 09.00-15.00',
    image: 'https://plus.unsplash.com/premium_photo-1744148531931-51d1a1c45590?q=80&w=1384&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    name: 'Bank Sampah Harapan Baru',
    address: 'Jl. Pahlawan No. 10, Bogor',
    operationalHours: 'Setiap Hari, 07.00-17.00',
    image: 'https://images.unsplash.com/photo-1651346864838-26f9b20b3559?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
])
...
<template>
  <div class="bg-white min-h-screen flex flex-col">
    ...
    <div class="relative h-52 bg-cover bg-center flex items-center justify-center"
...
<section class="container mx-auto px-6 py-8">
  ...
  <form
    ...
    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 bg-gray-50 p-6 rounded-lg shadow-md"
  >
    ...
    <button
      type="submit"
      class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-md transition col-span-full"
    >
      Tambah Bank Sampah
    </button>
  </form>
    ...
    <section class="flex-grow container mx-auto px-6 py-12">
      <h2 class="text-2xl font-bold mb-4 text-center">
        <span class="text-green-700 italic">Daftar Bank Sampah Mitra BuangYuk</span>
      </h2>
      <p class="mb-24 text-gray-600 text-center">
        Temukan bank sampah terdekat dari lokasi Anda!
      </p>

      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <bank-sampah-card
          v-for="bank in limitedBanks"
          :key="bank.name"
          :bank="bank"
        />
      </div>
    ...
    <footer class="bg-green-600 text-white text-center py-4 mt-auto">
      <p class="text-sm">Copyright &copy; 2054 My_Tutor | Designed By BuangYuk</p>
    </footer>
